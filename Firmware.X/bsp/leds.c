...
#define LED_D2_LAT LATDbits.LATD2
#define LED_D3_LAT LATDbits.LATD1
#define LED_D4_LAT LATDbits.LATD0

#define LED_D1_TRIS TRISDbits.TRISD3
#define LED_D2_TRIS TRISDbits.TRISD2
#define LED_D3_TRIS TRISDbits.TRISD1
#define LED_D4_TRIS TRISDbits.TRISD0
