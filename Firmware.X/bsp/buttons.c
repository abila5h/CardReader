...
#define S4_PORT  PORTBbits.RB3 //our connection to use s4 and s5
#define S5_PORT PORTBbits.RB2

#define S2_TRIS  TRISBbits.TRISB4
#define S3_TRIS  TRISBbits.TRISB5
#define S4_TRIS  TRISBbits.TRISB3
#define S5_TRIS  TRISBbits.TRISB2
